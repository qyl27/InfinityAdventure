...
public class ModPlacedFeatures {
    ...
    public static final RegistryObject<PlacedFeature> MITHRIL_ORE = PLACEMENT_FEATURES.register("mithril_ore", () -> new PlacedFeature(ModConfiguredFeatures.MITHRIL_ORE.getHolder().get(), commonOrePlacement(2, HeightRangePlacement.uniform(VerticalAnchor.absolute(-20), VerticalAnchor.absolute(25)))));
    public static final RegistryObject<PlacedFeature> ADAMANTINE_ORE = PLACEMENT_FEATURES.register("adamantine_ore", () -> new PlacedFeature(ModConfiguredFeatures.ADAMANTINE_ORE.getHolder().get(), commonOrePlacement(1, HeightRangePlacement.uniform(VerticalAnchor.absolute(-50), VerticalAnchor.absolute(20)))));
    public static final RegistryObject<PlacedFeature> RUBY_ORE = PLACEMENT_FEATURES.register("ruby_ore", () -> new PlacedFeature(ModConfiguredFeatures.RUBY_ORE.getHolder().get(), commonOrePlacement(2, HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(30)))));
